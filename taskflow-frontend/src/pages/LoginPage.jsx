  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-mist-100 transition hover:bg-white/10 disabled:opacity-50"
      >
        {googleLoading ? (
      ...
      <div className="relative my-4 flex items-center">
        ...
        <span className="mx-3 text-xs text-mist-100/40">or continue with email</span>
        <div className="flex-1 border-t border-white/10" />
      </div>
